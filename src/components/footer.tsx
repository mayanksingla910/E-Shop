...
export default function Footer() {
  return (
    <div className="bg-gray-100 py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 tex-sm mt-24">
      <div className="flex flex-col md:flex-row justify-between gap-24">
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">E-SHOP</div>
          </Link>
          <p>a-64, Noida, Delhi, India</p>
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <h1 className="font-medium text-lg">SUBSCIRBE</h1>
          <p>
